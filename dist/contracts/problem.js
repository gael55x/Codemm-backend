...
const CppTestSuiteSchema = zod_1.z
    ...
    if (!(0, rules_3.isValidCppTestSuite)(ts, 8)) {
        ctx.addIssue({
            code: zod_1.z.ZodIssueCode.custom,
            message: 'Invalid test_suite: must #include "solution.cpp", define a main(), print [PASS]/[FAIL] lines, and include exactly 8 tests named test_case_1..test_case_8 (RUN_TEST must be variadic).',
        });
    }
});
